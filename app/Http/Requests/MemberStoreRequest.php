...
class MemberStoreRequest extends FormRequest
{
    ...
    public function messages(){
        return [
            ...
            */
            "employment.required" => "Ingresa tu ocupación",
            ...
            "dependent.required" => "Ingresa el número de dependientes económicos", 
            
            "loc_col.required" => "Ingresa el nombre de tu localidad o colonia",
            "domicilioINE.required" => "Ingresa el domicilio idéntico a como esta en tu INE o IFE",            
